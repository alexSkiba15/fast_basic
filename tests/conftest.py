...
# WARNING: Ensure imports from `fast_basic` comes after this line
from fast_basic import app, settings, db  # noqa
from fast_basic.cli import create_user, cli  # noqa
